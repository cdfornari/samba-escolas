...
export class TituloHistoryResolver {
  ...
  createTituloHistory(@Args('createTituloHistoryInput') createTituloHistoryInput: CreateTituloHistoryInput) {
  ...
  findOne(@Args('titulo', { type: () => TituloHistoryIdArgs }) tituloHistoryIdArgs: TituloHistoryIdArgs) {
    return this.tituloHistoryService.findOne(tituloHistoryIdArgs);
  }

  @Mutation(() => TituloHistory)
  updateTituloHistory(@Args('updateTituloHistoryInput') updateTituloHistoryInput: UpdateTituloHistoryInput) {
